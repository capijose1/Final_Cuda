...
mcts:		./out/main.o ./out/common.o ./out/reversi.o ./out/cut.o ./out/mpi.o  ./out/parser.o ./out/cutil.o ./out/multithreading.o ./out/mcts.o 
		mpicxx -O3 -o mcts ./out/main.o ./out/common.o ./out/reversi.o ./out/mpi.o ./out/cut.o ./out/cutil.o ./out/parser.o ./out/multithreading.o ./out/mcts.o -L/usr/local/cuda/lib64 -lcudart -lcurses -lpthread
